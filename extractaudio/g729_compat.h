...
#  define G729_DINIT initBcg729DecoderChannel#  define G729_EINIT(vad) initBcg729EncoderChannel((vad))
...
#  define G729_EINIT(vad) initBcg729EncoderChannel((vad))
#  define G729_ECLOSE closeBcg729EncoderChannel
#  define G729_DINIT initBcg729DecoderChannel#  define G729_EINIT(vad) g729_encoder_new()
